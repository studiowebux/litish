...
**LSP / formatters:** nil (Nix LSP), yaml-language-server, bash-language-server, prettier, sqlparse (sqlformat), vscode-langservers-extracted (JSON/HTML/CSS LSP), typescript-language-server, pyright, ruff, dockerfile-language-server
